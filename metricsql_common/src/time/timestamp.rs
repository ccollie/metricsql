...
use super::error::{ArithmeticOverflowSnafu, Error, ParseTimestampSnafu, TimestampOverflowSnafu};
use super::timezone::{get_timezone, Timezone};
use super::util::div_ceil;
...
impl Timestamp {
    ...
    pub fn current_millis() -> Self {
        Self {
            value: super::util::current_time_millis(),
...
mod tests {
    ...
    use crate::prelude::timezone::set_default_timezone;
