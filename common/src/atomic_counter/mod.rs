...
//! Copied from https://github.com/kosta/atomic-counter, with u64-based counters added
//!
...
//!
//! So to maintain invariants such as `a > b` across multiple threads,
...
/// Implementation of [`AtomicCounter`](trait.AtomicCounter.html) that uses
/// [`Relaxed`](https://doc.rust-lang.org/std/sync/atomic/enum.Ordering.html#variant.Relaxed)
/// memory ordering for u64.
///
/// See [crate level documentation](index.html) for more details.
///
/// Note that all operations wrap if the counter is incremented beyond u64::max_value().
#[derive(Debug, Default)]
...
impl AtomicCounter for RelaxedU64Counter {
