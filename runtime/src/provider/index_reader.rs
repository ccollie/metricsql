...
pub trait IndexReader {
    type Items<'a>: PostingsIterator<'a>
    where
        Self: 'a;

    async fn all_postings<'a>(&'a self) -> ProviderResult<Self::Items<'a>>;
    ...
    async fn postings<'a>(&'a self, name: &str, values: &[&str])
        -> ProviderResult<Self::Items<'a>>;
