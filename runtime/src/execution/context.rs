...
/// Engine config which sets the context for query execution
pub struct Context {
...
pub struct SessionConfig {
    ...
    /// Too small a value can result in incomplete last points for query results
    ...
    /// The maximum number of points per series which a subquery can generate.
