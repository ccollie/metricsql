...
use crate::eval::binary::{exec_binop, BinaryOpFuncArg};
use crate::eval::utils::series_len;
use crate::functions::rollup::{
    get_rollup_function_handler, RollupConfig, RollupHandler, TimeseriesMap,
};
use crate::{
    Context, EvalConfig, InstantVector, MetricName, QueryValue, RuntimeError, RuntimeResult,
...
pub(crate) fn resolve_value(index: usize, value: &mut QueryValue, computed: &mut [QueryValue]) {
    ...
    //          or label_set(10, "foo", "qwert", "__name__", "q2")
    //      ) keep_metric_names)
    //
