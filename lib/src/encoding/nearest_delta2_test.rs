...
mod tests {
    ...
    fn test_marshal_int64nearest_delta2() {
        ...
        check_marshal_i64_nearest_delta2(
            &[-5000, -6000, -7000, -8000, -8_900_000_000_000],
            1,
            -5000,
            "cf0f000000",
        );
    ...
    fn check_marshal_i64_nearest_delta2(
        va: &[i64],
        precision_bits: u8,
        ...
        let first_value = marshal_int64_nearest_delta2(&mut b, va, precision_bits)
            .expect("marshal i64 nearest delta2");
        assert_eq!(
            first_value, first_value_expected,
            "unexpected first_value for va={:?}, precision_bits={}; got {}; want {}",
            va, precision_bits, first_value, first_value_expected
    ...
    fn test_nearest_delta() {
        ...
        check_nearest_delta(1234e12 as i64, 1235e12 as i64, 1, 0, 50);
        check_nearest_delta(1234e12 as i64, 1235e12 as i64, 10, 0, 41);
        check_nearest_delta(1234e12 as i64, 1235e12 as i64, 35, -999999995904, 16);

        // changed from 1 << 63 - 1 because of overflow
        check_nearest_delta((1_i64 << 62) - 1, 0, 1, (1_i64 << 62) - 1, 2);
    }

    fn check_nearest_delta(
        next: i64,
        prev: i64,
        precision_bits: u8,
        d_expected: i64,
        ...
        assert_eq!(
            d, d_expected,
            "unexpected d for next={}, prev={}, precision_bits={}; got {}; expecting {}",
            next, prev, precision_bits, d, d_expected
        );
    ...
    fn test_marshal_unmarshal_int64nearest_delta2() {
        ...
        check_marshal_unmarshal_int64_nearest_delta2(
            &[
                -5e12 as i64,
                -6e12 as i64,
                -7e12 as i64,
    ...
    fn check_marshal_unmarshal_int64_nearest_delta2(va: &[i64], precision_bits: u8) {
        ...
        let first_value = marshal_int64_nearest_delta2(&mut src, va, precision_bits)
            .expect("marshal nearest delta 2");
