...
pub use column_schema::{ColumnSchema, Metadata, COMMENT_KEY, TIME_INDEX_KEY};
pub use constraint::ColumnDefaultConstraint;
pub use raw::RawSchema;

use crate::datatypes::error::{DuplicateColumnSnafu, ProjectArrowSchemaSnafu};
...
mod tests {
    ...
    use crate::datatypes::Error::DuplicateColumn;
