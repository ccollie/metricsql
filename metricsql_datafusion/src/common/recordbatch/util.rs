...
use crate::common::recordbatch::{RecordBatch, RecordBatches, SendableRecordBatchStream};
...
mod tests {
    ...
    use crate::common::recordbatch::{RecordBatch, RecordBatchStream};
    ...
    async fn test_collect() {
        ...
        let columns = [Arc::new(UInt32Array::from(numbers)) as _];
