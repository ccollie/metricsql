...
use crate::datasource::error::{
    Error, InferSchemaSnafu, JoinHandleSnafu, ParseFormatSnafu, ReadObjectSnafu,
    Result, WriteRecordBatchSnafu
};
...
#[cfg(test)]
mod tests {
    use crate::datasource::file_format::{FORMAT_COMPRESSION_TYPE, FORMAT_DELIMITER, FORMAT_HAS_HEADER, FORMAT_SCHEMA_INFER_MAX_RECORD};
