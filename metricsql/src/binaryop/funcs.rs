...
const fn get_comparison_handler(op: Operator, is_bool: bool) -> BinopFunc {
    if is_bool {
        match op {
...
pub const fn get_scalar_binop_handler(op: Operator, is_bool: bool) -> BinopFunc {
    match op {
        ...
        Operator::Eql => get_comparison_handler(Operator::Eql, is_bool),
        Operator::NotEq => get_comparison_handler(Operator::NotEq, is_bool),
        Operator::Gt => get_comparison_handler(Operator::Gt, is_bool),
        Operator::Lt => get_comparison_handler(Operator::Lt, is_bool),
        Operator::Gte => get_comparison_handler(Operator::Gte, is_bool),
        Operator::Lte => get_comparison_handler(Operator::Lte, is_bool),
    }
}
