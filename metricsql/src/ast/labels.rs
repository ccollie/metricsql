...
pub trait LabelsTrait {
    fn with(&self, names: &[String]) -> Self;
...
impl LabelMatcher {
    ...
    pub fn equal<S: Into<String>>(key: S, value: S) -> Result<Self> {
        LabelMatcher::new(key, MatchOp::Eql, value)
    }

    pub fn not_equal<S: Into<String>>(key: S, value: S) -> Result<Self> {
        LabelMatcher::new(key, MatchOp::Neq, value)
    }

    pub fn regex_equal<S: Into<String>>(key: S, value: S) -> Result<Self> {
        LabelMatcher::new(key, MatchOp::EqlRe, value)
    }

    pub fn regex_notequal<S: Into<String>>(key: S, value: S) -> Result<Self> {
        LabelMatcher::new(key, MatchOp::NeqRe, value)
    }

    pub fn is_negative(&self) -> bool {
        matches!(self.match_op, MatchOp::NeqRe | MatchOp::Neq)
    }

    pub fn is_regex(&self) -> bool {
        matches!(self.match_op, MatchOp::EqlRe | MatchOp::NeqRe)
    }
}
...
impl fmt::Display for MatchOp {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            MatchOp::Eql => write!(f, "="),
            MatchOp::Neq => write!(f, "!="),
            MatchOp::EqlRe => write!(f, "=~"),
            MatchOp::NeqRe => write!(f, "!~"),
        }
    }
}
